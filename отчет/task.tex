...
\begin{center}
    ...
    Казаковой Диане Александровне, % нужно указать в дательном падеже (задание кому?)
...
на тему «Разработка веб-приложения для управления личным гардеробом с возможностью формирования пользовательских образов»
...
\begin{longtable}{|P{0.5\textwidth}|C{0.11\textwidth}|C{0.15\textwidth}|C{0.24\textwidth}|}
    ...
    Задача 1.1. Обзор существующих веб-сервисов для управления гардеробом и подбора образов                              & 10                 & 15.04.2026    &                     \\ \hline
    Задача 1.2. Анализ программных инструментов разработки веб-приложений                            & 7                  & 17.04.2026    &                     \\ \hline
    ...
    Задача 2.1. Анализ целевой аудитории                                                             & 5                  & 02.05.2026    &                     \\ \hline
    Задача 2.2. Описание функциональности веб-приложения для управления гардеробом и формирования пользовательских образов (диаграмма вариантов использования, user story) & 7                  & 06.05.2026    &                     \\ \hline
    Задача 2.3. Проектирование модели данных (ER-диаграмма, логическая и физическая схемы БД)        & 8                  & 10.05.2026    &                     \\ \hline
    Задача 2.4. Разработка макетов страниц (Wireframe)                                               & 5                  & 15.05.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 3. Разработка веб-приложения}}                                                                              \\ \hline
    Задача 3.1. Разработка базовой структуры веб-приложения и настройка окружения                  & 6                  & 20.05.2026    &                     \\ \hline
    Задача 3.2. Реализация системы аутентификации, авторизации и разграничения прав доступа по ролям пользователей                                              & 7                  & 25.05.2026    &                     \\ \hline
    Задача 3.3. Реализация CRUD-интерфейса управления элементами гардероба         & 10                  & 30.05.2026    &                     \\ \hline
    Задача 3.4. Реализация формирования и управления пользовательскими образами на основе элементов гардероба                                           & 10                 & 05.06.2026    &                     \\ \hline
    Задача 3.5. Реализация загрузки, хранения и выгрузки изображений                                                  & 7                  & 09.06.2026    &                     \\ \hline

    \multicolumn{4}{|P{\textwidth}|}{\textbf{Раздел 4. Оформление итогов работы}}                                                                               \\ \hline
    Задача 4.1. Создание Git-репозитория с кодом проекта                                             & 2                  & 10.06.2026    &                     \\ \hline
    Задача 4.2. Деплой приложения на хостинг                                                         & 4                  & 11.06.2026    &                     \\ \hline
    Задача 4.3. Оформление отчёта о проделанной работе                                               & 4                  & 13.06.2026    &                     \\ \hline
\end{longtable}
}
...
\begin{tabularx}{\textwidth}{@{} P{0.45\textwidth} P{0.3\textwidth} P{0.25\textwidth} @{}}
    ...
    «14» \quad апреля \quad 2026~г. &
    \centering 
    \includegraphics[width=3.5cm]{images/sign.png}
    \par \footnotesize (подпись) &
    \hfill Д. А. Казакова                                           \\
\end{tabularx}
}
